...
export const Card = ({ img, text, url, large }) => {
  ...
  return (
    <a href={url} target='_blank' rel='noreferrer' className='relative flex-grow bg-white overflow-hidden shadow-md hover:shadow-lg trans trans-fast lg:pb-10 py-5'>
